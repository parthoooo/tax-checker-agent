        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="integrations">
            <div className="space-y-4">
              {[
                {
                  name: 'CCH Axcess', color: 'blue', icon: Database,
                  status: 'Needs API credentials from Nick/Andrew',
                  effort: 12,
                  what: 'Sync client list from CCH, import prior-year return data to pre-fill input sheets, push completed tax data back for e-filing.',
                  steps: [
                  ...
                  blocker: 'CCH API credentials — contact Andrew or Nick Muqtadir'
                },
                {
                  name: 'SignNow E-Signature', color: 'green', icon: GitBranch,
                  status: 'Account created — API key needed',
                  effort: 7,
                  what: 'Create e-signature requests for Form 8879 and state returns. Track status, notify preparer on completion.',
                  steps: [
                  ...
                  blocker: 'SignNow API credentials — contact Nick'
                },
                {
                  name: 'Microsoft Outlook', color: 'indigo', icon: Zap,
                  status: 'Needs Microsoft 365 app registration',
                  effort: 8,
                  what: 'Send approved emails from each preparer\'s own Outlook mailbox via Microsoft Graph API. Per-preparer OAuth consent.',
                  steps: [
                  ...
                  blocker: 'Microsoft 365 admin access — contact IT or Nick'
                },
                {
                  name: 'Claude AI (Document Validation)', color: 'purple', icon: Zap,
                  status: 'Simulated — ready to activate',
                  effort: 8,
                ...
                },
                {
                  ...
                  status: 'Simple drop-in when Outlook is not ready',
                  effort: 2,
